window.onload = function() {
    ...
    var days = [{
        "day": 0,
        "score": 20,
        "instruction": "<p>Fishing for words. <br>Fish will appear and swim by<br>You need to catch fish with the correct prefix, <br>suffix, and root to form a word.</p><p>You will get score for each <br>part of the word that you correctly form.<br> You will select words from the paper.</p>"
    },{
        "day": 1,
        "score": 30,
        "instruction": "There will be harder words worth more points."
    },{
        "day": 2,
        "score": 35,
        "instruction": "Trash will appear now. <br>There is penalty if you catch trash. <br>"
    },{
        "day": 3,
        "score": 40,
        "instruction": "There are now jellyfish.<br>They will freeze you<br>Continue and avoid getting stunned by them!"
    },{
        "day": 4,
        "score": 45,
        "instruction": "There are now sharks.<br>You have to back at zero if you catch them."
    }];
